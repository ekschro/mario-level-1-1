...
namespace Game1
{
    public class HeadsUpDisplay
    {
        ...
        public void Draw()
        {
            ...
            myGame.SpriteBatch.DrawString(myGame.SpriteFont, "000000", new Vector2(10, 25), Color.White);
            ...
            myGame.SpriteBatch.DrawString(myGame.SpriteFont, "00", new Vector2(115, 25), Color.White);
            myGame.SpriteBatch.DrawString(myGame.SpriteFont, "1-1", new Vector2(200, 25), Color.White);
            myGame.SpriteBatch.DrawString(myGame.SpriteFont, "365", new Vector2(300, 25), Color.White);
