...
namespace Game1
{
    public class MarioBigWalkLeftPart2 : ISprite
    {
        ...
        public MarioBigWalkLeftPart2(Game1 game, Mario mario)
        {
            myGame = game;
            marioObject = mario;
        }
        ...
        {
            marioObject.marioSprite = new MarioBigWalkLeftPart3(myGame, marioObject);
        }
