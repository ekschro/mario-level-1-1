...
namespace Game1
{
    public class MarioBigWalkLeftPart3 : ISprite
    {
        ...
        public MarioBigWalkLeftPart3(Game1 game, Mario mario)
        {
            myGame = game;
            marioObject = mario;
        }
        ...
        {
            marioObject.marioSprite = new MarioBigWalkLeftPart4(myGame, marioObject);
        }
