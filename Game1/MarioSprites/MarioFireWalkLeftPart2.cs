...
namespace Game1
{
    public class MarioFireWalkLeftPart2 : ISprite
    {
        ...
        public MarioFireWalkLeftPart2(Game1 game, Mario mario)
        {
            myGame = game;
            marioObject = mario;
        }
        ...
        {
            marioObject.marioSprite = new MarioFireWalkLeftPart3(myGame, marioObject);
        }
